...
class Customer(db.Model):
    ...
    # Association proxy to access reviewed items directly
...
class ReviewSchema(Schema):
    ...
    # Include nested customer/item but exclude their reviews to prevent recursion
...
class CustomerSchema(Schema):
    ...
    # Include reviews, but exclude the "customer" key inside each review
...
class ItemSchema(Schema):
    ...
    # Include reviews, but exclude the "item" key inside each review
